...
def generate_launch_description():
    ...
    ft_pkg = get_package_share_directory("feature_tracker")
    ve_pkg = get_package_share_directory("vins_estimator")

    bridge_cfg = os.path.join(bridge_pkg, "config", "vins_mono_bridge.yaml")
    ft_launch = os.path.join(ft_pkg, "launch", "px4_downcam.launch.py")
    ve_launch = os.path.join(ve_pkg, "launch", "px4_downcam.launch.py")
