...
if (NOT COMMAND ament_target_dependencies)
    function(ament_target_dependencies target)
        foreach(dep IN LISTS ARGN)
            ...
            elseif (dep STREQUAL "cv_bridge" AND TARGET cv_bridge::cv_bridge)
                target_link_libraries(${target} cv_bridge::cv_bridge)
