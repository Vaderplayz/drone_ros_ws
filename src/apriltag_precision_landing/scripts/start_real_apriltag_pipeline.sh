...
FCU_URL="${FCU_URL:-serial:///dev/serial/by-id/usb-MicoAir_MicoAir743AIO_0-if00:115200}"
MAVROS_RESPAWN="${MAVROS_RESPAWN:-true}"

VIDEO_DEVICE="${VIDEO_DEVICE:-/dev/v4l/by-id/usb-Sonix_Technology_Co.__Ltd._USB2.0_HD_UVC_WebCam-video-index0}"
...
DETECTOR_PUBLISH_IMAGE_STREAM="${DETECTOR_PUBLISH_IMAGE_STREAM:-0}"
