...
DETECTOR_PUBLISH_IMAGE_STREAM="${DETECTOR_PUBLISH_IMAGE_STREAM:-true}"
DETECTOR_PREVIEW_START_ENABLED="${DETECTOR_PREVIEW_START_ENABLED:-false}"
DETECTOR_PREVIEW_RATE_HZ="${DETECTOR_PREVIEW_RATE_HZ:-5.0}"
DETECTOR_PREVIEW_WIDTH="${DETECTOR_PREVIEW_WIDTH:-320}"
DETECTOR_PREVIEW_HEIGHT="${DETECTOR_PREVIEW_HEIGHT:-240}"
...
CAMERA_OFFSET_X="${CAMERA_OFFSET_X:-0.10}"
...
start_detector() {
  ...
  local cmd=(ros2 run apriltag_precision_landing apriltag_camera_detector_node
    ...
    -p "preview_start_enabled:=${DETECTOR_PREVIEW_START_ENABLED}"
    -p "preview_rate_hz:=${DETECTOR_PREVIEW_RATE_HZ}"
    -p "preview_width:=${DETECTOR_PREVIEW_WIDTH}"
    -p "preview_height:=${DETECTOR_PREVIEW_HEIGHT}"
